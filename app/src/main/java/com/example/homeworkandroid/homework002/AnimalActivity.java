...
public class AnimalActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void setListeners() {
        ...
        ((RadioGroup) findViewById(R.id.rgrType))
                .setOnCheckedChangeListener((group, checkedId) -> onTypeRBchanged(group, checkedId));
    ...
    private void fillSpinner(Spinner spinner, AnimalType type) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AnimalActivity.this,
...
//        }
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == SELECT_PICTURE) {
                ...
                findViewById(R.id.imageViewImg).post(new Runnable() {
                    @Override
                    public void run() {
                        ((ImageView) findViewById(R.id.imageViewImg)).setImageURI(selectedImageUri);
                    }
                });
