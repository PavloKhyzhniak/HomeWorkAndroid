...
public class User {
    ...
    private long AddressId;      // ИД адресса

    public User(long _Id, String _FirstName, String _SecondName, String _LastName, Date _BirthDate, long _AddressId){
        this.Id = _Id;
    ...
    public String toString() {
        return String.format("%d : %s %s %s %s : %d", Id, FirstName, SecondName, LastName, new SimpleDateFormat("yyyy-MM-dd").format(BirthDate), AddressId);
    } // toString
